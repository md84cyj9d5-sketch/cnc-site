...
const projects: readonly PortfolioProject[] = [
  ...
  {
    title: "Ажурная резьба по дереву",
    description: "Фрезеровка сквозных декоративных панелей с растительным орнаментом.",
    images: [{ src: "/images/portfolio/work-05.webp", alt: "Ажурная резьба по дереву с геометрическим и растительным орнаментом" }],
  },
  {
    title: "Декоративная накладка",
    description: "Изготовление небольшого элемента с рельефным орнаментом.",
    images: [{ src: "/images/portfolio/work-04.webp", alt: "Небольшая декоративная накладка с гравированным орнаментом" }],
  },
  {
    title: "Реставрация царских врат",
    description: "Полная реставрация царских врат с изготовлением резного фона на ЧПУ.",
    images: [{ src: "/images/portfolio/work-12.webp", alt: "Царские врата после реставрации с резным фоном" }],
  },
  {
  ...
  {
    title: "Декоративный элемент киота",
    description: "Изготовление фигурной детали с гравировкой и металлической накладкой.",
    images: [
      { src: "/images/portfolio/work-06.webp", alt: "Фигурный декоративный элемент киота с гравировкой и металлической накладкой" },
      { src: "/images/portfolio/work-07.webp", alt: "Декоративный элемент в составе золочёной рамы киота" },
    ],
  },
  {
  ...
  {
    title: "Гравировка таблички на ЧПУ",
    description: "Точная машинная гравировка текста по подготовленному макету.",
    images: [{ src: "/images/portfolio/work-03.webp", alt: "Металлическая табличка с машинной гравировкой и скрытой областью персональных данных" }],
  },
] as const;
